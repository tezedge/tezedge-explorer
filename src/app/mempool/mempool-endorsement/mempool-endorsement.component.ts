...
@Component({
  ...
  animations: [fadeInOut, fadeInOut2, rowsAnimation1, rowsAnimation2],
})
export class MempoolEndorsementComponent implements OnInit, OnDestroy {
  ...
  private listenToNewAppliedBlock(): void {
    ...
    ).subscribe(() => this.store.dispatch<MempoolEndorsementLoad>({ type: MEMPOOL_ENDORSEMENT_LOAD }));
  }
