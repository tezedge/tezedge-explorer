...
exports.pendingOperationsAtomic = exports.pendingOperation = void 0;
 ...
 */
exports.pendingOperation = (selector) => (source) => source.pipe(operators_1.map(state => (Object.assign(Object.assign({}, state), { pendingOperation: selector(state) }))), exports.pendingOperationsAtomic(), 
