...
exports.ready = exports.keys = exports.parseAmount = exports.publicKeyHash2buffer = exports.concatKeys = exports.base58CheckDecode = exports.bs58checkEncode = exports.prefix = void 0;
 ...
 * @param encoded
 */
function publicKeyHash2buffer(publicKeyHash) {
    switch (publicKeyHash.substr(0, 3)) {
        case 'tz1':
            return {
                originated: 0,
                hash: concatKeys(new Uint8Array([0]), base58CheckDecode(exports.prefix.tz1, publicKeyHash)),
            };
        case 'tz2':
            return {
                originated: 0,
                hash: concatKeys(new Uint8Array([1]), base58CheckDecode(exports.prefix.tz2, publicKeyHash)),
            };
        case 'tz3':
            return {
                originated: 0,
                hash: concatKeys(new Uint8Array([2]), base58CheckDecode(exports.prefix.tz3, publicKeyHash)),
            };
        case 'KT1':
            return {
                originated: 1,
                hash: concatKeys(new Uint8Array([1]), concatKeys(base58CheckDecode(exports.prefix.KT1, publicKeyHash), new Uint8Array([0]))),
            };
        default:
            throw new Error('Wrong Tezos publicKeyHash address');
    }
}
exports.publicKeyHash2buffer = publicKeyHash2buffer;
/**
