...
@UntilDestroy()
@Component({
  templateUrl: './rewards-connect-ledger-dialog.component.html',
  styleUrls: ['./rewards-connect-ledger-dialog.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [{ provide: CdkStepper }]
})
export class RewardsConnectLedgerDialogComponent implements AfterViewInit {
  ...
  constructor(private dialogRef: MatDialogRef<RewardsConnectLedgerDialogComponent>,
