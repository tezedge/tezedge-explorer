...
enum SmartContractsActionTypes {
  ...
  SMART_CONTRACTS_RUN = 'SMART_CONTRACTS_RUN',
  SMART_CONTRACTS_GET_TRACE = 'SMART_CONTRACTS_GET_TRACE',
  SMART_CONTRACTS_GET_TRACE_SUCCESS = 'SMART_CONTRACTS_GET_TRACE_SUCCESS',
...
export const SMART_CONTRACTS_RUN = SmartContractsActionTypes.SMART_CONTRACTS_RUN;
export const SMART_CONTRACTS_GET_TRACE = SmartContractsActionTypes.SMART_CONTRACTS_GET_TRACE;
export const SMART_CONTRACTS_GET_TRACE_SUCCESS = SmartContractsActionTypes.SMART_CONTRACTS_GET_TRACE_SUCCESS;
...
export class SmartContractsGetTraceSuccessAction implements Action {
  readonly type = SMART_CONTRACTS_GET_TRACE_SUCCESS;
...
export type SmartContractAction = SmartContractsGetTraceSuccessAction
