...
exports.confirmOperation = void 0;
 ...
 */
exports.confirmOperation = (selector) => (source) => source.pipe(operators_1.map(state => (Object.assign(Object.assign({}, state), { confirmOperation: selector(state) }))), operators_1.tap((state) => console.log(`[-] pending: operation "${state.confirmOperation.injectionOperation}"`)), 
