...
context('OPEN API', () => {
  ...
  it('[OPEN API] should render HTML', () => testForTezedge(() => {
  ...
  it('[OPEN API] should render RPC list on row click', () => testForTezedge(() => {
  ...
  it('[OPEN API] should render RPC\'s details on click', () => testForTezedge(() => {
    cy.get('.swagger-ui .wrapper:nth-child(4) section div span:nth-child(1) .opblock-tag-section h3').click()
      .wait(500)
