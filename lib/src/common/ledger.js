...
// @ts-ignore
const hw_app_xtz_1 = require("@obsidiansystems/hw-app-xtz");
class LedgerUtils {
    constructor() {
        this.prefix = {
    ...
    getPublicAddress(path, transportHolder) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const xtz = new hw_app_xtz_1.default(this.transport);
    ...
    pk2pkh(pk) {
        if (pk.length === 54 && pk.slice(0, 4) === 'edpk') {
            ...
            const payload = blakejs_1.blake2b(pkDecoded, undefined, 20);
...
exports.LedgerUtils = LedgerUtils;
