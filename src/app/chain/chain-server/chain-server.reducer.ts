const initialState: any = {
	form: {
		...
		lowerPeerTreshold: 1,
		higherPeerTreshold: 1,
    synchronizationThresh: 0,
		peers: '',
...
export function mapFieldName(field_name: string){
    ...
    synchronizationThresh: 'synchronizationThresh',
    ...
    actions_store_backend: 'recordingContextActions',
