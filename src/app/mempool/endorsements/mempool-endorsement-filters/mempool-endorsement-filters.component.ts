import { Component, OnInit, ChangeDetectionStrategy, ViewChild, ElementRef, ChangeDetectorRef, NgZone } from '@angular/core';
...
import { mempoolBakingRightsCurrentDisplayedBlock, mempoolBakingRightsState } from '@mempool/baking-rights/mempool-baking-rights/mempool-baking-rights.reducer';
...
import {
  ...
  MEMPOOL_BAKING_RIGHTS_PAUSE, MempoolBakingRightsChangeRound,
...
@UntilDestroy()
@Component({
  selector: 'app-endorsement-filters',
  templateUrl: './mempool-endorsement-filters.component.html',
  styleUrls: ['./mempool-endorsement-filters.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MempoolEndorsementFiltersComponent implements OnInit {
