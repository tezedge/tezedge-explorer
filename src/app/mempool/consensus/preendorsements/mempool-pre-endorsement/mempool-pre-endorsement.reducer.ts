...
export function reducer(state: MempoolPreEndorsementState = initialState, action: MempoolPreEndorsementActions): MempoolPreEndorsementState {
  ...
  switch (action.type) {
    ...
    case MEMPOOL_PREENDORSEMENT_SET_ROUND: {
...
export const selectMempoolPreEndorsementCurrentRound = (state: State): MempoolConsensusRound => state.mempool.preendorsementState.currentRound;
